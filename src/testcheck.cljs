...
(defn ^boolean Generator?
  [x]
  (and ^boolean x (exists? (aget x "__clj_gen"))))

(declare convert-gen)

; Iterates through a provided Array. If any value is a Generator or contains
; a Generator, then a gen/tuple is returned.
...
; Iterates through a provided Object. If any value is a Generator or contains
; a Generator, then a record generator is returned.
...
; Common point of the recursive production of Generators from values.
...
; If provided a JS Generator, converts it to a Clojure gen/generator.
